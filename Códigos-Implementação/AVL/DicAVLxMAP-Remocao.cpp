...
//Funções usadas para gerar um vetor com valores aleatórios não repetidos
//Utilizei trechos dos códigos do professor Gilberto Toledo, disponível em https://github.com/gilbertotoledo/curso-c-cpp
...
int main(){
    ...
    int N = 15000000; //Número de nós da árvore/Mapa. Range 4.000.000-15.000.000
    ...
    //int numeros[num_rodadas]; //Vetor que será povoado com números aleatórios não repetidos
    std::cout<<"N = "<<N<<" - Numero de rodadas = "<<num_rodadas<<std::endl;
    std::cout<<std::endl;
    //GeraAleatorios(numeros,num_rodadas,N);// Vetor com valores aleatórios para remover
